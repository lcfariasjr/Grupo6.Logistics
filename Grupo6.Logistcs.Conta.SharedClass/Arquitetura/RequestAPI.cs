...
namespace Grupo6.Logistcs.Conta.SharedClass.Arquitetura
{
    public class RequestAPI
    {
        ...
        public string BuscarMaiorCodOppNaApi()
        {
            ...
            //var request = new RestRequest($"https://logisticssecundario.crm2.dynamics.com/api/data/v9.2/opportunities?$select=gp6_codopp&$orderby=gp6_codopp desc&$top=1", Method.Get);
            //request.AddHeader("Authorization", Token);

            //RestResponse response = client.Execute(request);
            var client = new HttpClient();
            var request = new HttpRequestMessage(HttpMethod.Get, "https://logisticssecundario.crm2.dynamics.com/api/data/v9.2/opportunities?$select=gp6_codopp&$orderby=gp6_codopp desc&$top=1");
